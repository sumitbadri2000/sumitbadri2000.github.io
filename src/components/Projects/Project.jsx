        ...
        <div className="flexs">
          ...
          <div className="info">
            ...
            <div className="tech">
              ...
              <img
                className="images"
                src="https://images.squarespace-cdn.com/content/v1/5df7d8d44b9a7a49b2e475ac/1576526689110-QJM10YTHVZYU7Z7D2YLE/js-logo.png"
                alt="js"
              />
            </div>
        ...
        <div className="flexs">
          ...
          <div className="info">
            ...
            <div className="tech">
              ...
              <img
                className="images"
                src="https://miro.medium.com/max/400/1*tX7DC-HhKR2blBSbf3xvtQ.jpeg"
                alt="json_server"
              />
            </div>
            <div className="website">
